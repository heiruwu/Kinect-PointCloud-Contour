...
namespace pcl
{
    ...
    class Kinect2Grabber : public pcl::Grabber
    {
        ...
        protected:
			...
			pcl::PointCloud<pcl::PointXYZ> createCloud(UINT16* depthBuffer);
			...
			virtual void savePly();
			virtual void constructObj();
            void threadFunction();
	...
	void pcl::Kinect2Grabber::constructObj() {
		...
		pcl::io::saveOBJFile("kinect_obj.obj", triangles);
		cout << "finished" << endl;
		system("pause");
	}

	void pcl::Kinect2Grabber::savePly() {
		pcl::io::savePLYFileASCII("Kinect_pointcloud.ply", createCloud(&depthBuffer[0]));
	}

	pcl::PointCloud<pcl::PointXYZ> pcl::Kinect2Grabber::createCloud(UINT16* depthBuffer) {
